"""Webhook writer – POST scraped submittal records to the Replit app."""
...
def send_submittal_records(records: list[dict], city: str) -> int:
    """Send submittal records to the Replit webhook endpoint.
